...
if 'RUN_POSITION' in os.environ and os.environ['RUN_POSITION'] == 'paddlecloud':
    ...
    pretrained_dir = project_dir / "initmodel"
...
pretrained_weights = {
    ...
    "ViT-B/16-dino":    pretrained_dir / "dino_vitbase16_pretrain.pth",
...
model_urls = {
    ...
    "ViT-B/16-dino":    "https://dl.fbaipublicfiles.com/dino/dino_vitbase16_pretrain/dino_vitbase16_pretrain.pth",
