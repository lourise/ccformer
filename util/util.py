...
def get_logger(log_path):
    ...
    handler = logging.FileHandler(log_path+'/{}.log'.format(logger_name), encoding='UTF-8')
...
def get_save_path(args):
    ...
    args.snapshot_path = 'exp/{}/{}/split{}/{}/snapshot/{}'.format(args.data_set, args.arch, args.split, backbone_str, args.exp_id)
    args.result_path = 'exp/{}/{}/split{}/{}/result/{}'.format(args.data_set, args.arch, args.split, backbone_str, args.exp_id)
